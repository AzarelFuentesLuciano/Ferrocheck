document.addEventListener('DOMContentLoaded', () => {
    ...
    const nuevoBtn = document.getElementById('ceNuevoEscanerBtn');
    const modal = document.getElementById('ceModalNuevo');
    ...
    modal?.querySelectorAll('[data-close="1"]').forEach((node) => {
