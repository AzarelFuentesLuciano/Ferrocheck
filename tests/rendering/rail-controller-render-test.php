...
$html = $controller->render(['seccion'=>'ferro','subseccion'=>'incidencias']);
...
$test('Rail no crea submenú en el sidebar', static fn (): bool => !str_contains($html, 'appShellSubmenu-rail'));
...
$test('sección y subsección quedan activas', static fn (): bool => str_contains($html, '<h1 id="railSectionTitle">Ferro</h1>') && str_contains($html, '<strong>Incidencias</strong>'));
